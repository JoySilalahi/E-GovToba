        ...
        <div class="container-fluid">
            ...
            <div class="welcome-card">
                ...
                <div class="vision-mission">
                    <p><strong>Visi</strong> : <?php echo e($district->visi ?? 'Toba Unggul dan Bersinar'); ?></p>
                    <p><strong>Misi</strong> : <?php echo e($district->misi ?? 'Meningkatkan kualitas sumber daya manusia yang andal dan berbudaya, mempercepat pembangunan infrastruktur, serta mewujudkan reformasi birokrasi yang bersih dan melayani.'); ?></p>
                </div>
                
                <div class="form-section">
                    <h5>Buat Visi dan Misi Baru :</h5>
                    <form action="<?php echo e(route('admin.update-visi-misi')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            <label for="visi" class="form-label">Visi</label>
                            <input type="text" class="form-control" id="visi" name="visi" value="<?php echo e(old('visi', $district->visi ?? '')); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="misi" class="form-label">Misi</label>
                            <textarea class="form-control" id="misi" name="misi" rows="3" required><?php echo e(old('misi', $district->misi ?? '')); ?></textarea>
                        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="stat-card">
                                ...
                                <div class="stat-value"><?php echo e(number_format($district->total_penduduk ?? 7515)); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="stat-card">
                                ...
                                <div class="stat-value"><?php echo e($district->villages->count() ?? 6); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="official-photo-card">
                                <form action="<?php echo e(route('admin.upload-bupati-photo')); ?>" method="POST" enctype="multipart/form-data" id="bupatiForm">
                                    <?php echo csrf_field(); ?>
                                ...
                                <div class="official-photo" onclick="showFullImage('<?php echo e(asset('images/bupati.jpg')); ?>?v=<?php echo e(time()); ?>', '<?php echo e($district->bupati_name ?? 'Bupati Toba'); ?>')" style="cursor: pointer;">
                                    <?php if(file_exists(public_path('images/bupati.jpg'))): ?>
                                        <img src="<?php echo e(asset('images/bupati.jpg')); ?>?v=<?php echo e(time()); ?>" alt="Bupati" style="object-position: top;">
                                    <?php else: ?>
                                        <i class="fas fa-user"></i>
                                    <?php endif; ?>
                                </div>
                                <div class="official-info">
                                    <form action="<?php echo e(route('admin.update-bupati')); ?>" method="POST" style="text-align: left; padding: 0.5rem;">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   name="bupati_name" 
                                                   value="<?php echo e($district->bupati_name ?? 'Effendi Simbolon Panangian Napitupulu'); ?>" 
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text" 
                                                   class="form-control form-control-sm" 
                                                   name="periode" 
                                                   value="<?php echo e($district->periode ?? '2024-2025'); ?>" 
                                                   style="font-size: 0.8rem; padding: 0.25rem 0.5rem;"
                        ...
                        <div class="col-md-6">
                            <div class="official-photo-card">
                                <form action="<?php echo e(route('admin.upload-wakil-photo')); ?>" method="POST" enctype="multipart/form-data" id="wakilForm">
                                    <?php echo csrf_field(); ?>
                                ...
                                <div class="official-photo" onclick="showFullImage('<?php echo e(asset('images/wakil-bupati.jpg')); ?>?v=<?php echo e(time()); ?>', '<?php echo e($district->wakil_bupati_name ?? 'Wakil Bupati Toba'); ?>')" style="cursor: pointer;">
                                    <?php if(file_exists(public_path('images/wakil-bupati.jpg'))): ?>
                                        <img src="<?php echo e(asset('images/wakil-bupati.jpg')); ?>?v=<?php echo e(time()); ?>" alt="Wakil Bupati" style="object-position: top;">
                                    <?php else: ?>
                                        <i class="fas fa-user"></i>
                                    <?php endif; ?>
                                </div>
                                <div class="official-info">
                                    <form action="<?php echo e(route('admin.update-wakil-bupati')); ?>" method="POST" style="text-align: left; padding: 0.5rem;">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PUT'); ?>
                                        <div class="mb-2">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   value="<?php echo e($district->wakil_bupati_name ?? 'Audi Murphy Sitorus'); ?>" 
                                                   style="font-size: 0.8rem; padding: 0.25rem 0.5rem;"
                                                   required>
                                        </div>
                                        <div class="mb-2">
            ...
            <div class="upload-card">
                ...
                <form action="<?php echo e(route('admin.upload-photo')); ?>" method="POST" enctype="multipart/form-data" id="uploadForm">
                    <?php echo csrf_field(); ?>
            ...
            <div class="upload-card" style="margin-top: 1.5rem;">
                <h4>Foto yang Sudah Diupload (<?php echo e($district->photos->count()); ?>)</h4>
                        ...
                        <div style="border: 1px solid #e0e0e0; border-radius: 6px; overflow: hidden; background: #fff;">
                            ...
                            <div style="padding: 0.75rem;">
                                <p style="margin: 0 0 0.5rem 0; font-weight: 600; font-size: 0.85rem; color: #2d3e50;">
                                    <?php echo e($photo->title ?? 'Tanpa Judul'); ?>

                                </p>
                                <p style="margin: 0 0 0.75rem 0; font-size: 0.75rem; color: #666;">
                                    <i class="far fa-calendar"></i> <?php echo e($photo->created_at->locale('id')->isoFormat('D MMM YYYY')); ?>

                                </p>
                                <form action="<?php echo e(route('admin.delete-photo', $photo->id)); ?>" 
                                      method="POST" 
...
<?php /**PATH C:\Users\ASUS\OneDrive\Documents\GitHub\E-GovToba\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>