...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        /* HERO rounded banner */
        .hero{max-width:var(--max-w);margin:28px auto 10px;padding:42px 28px;border-radius:14px;background-image:
            linear-gradient(180deg, rgba(8,40,66,0.42), rgba(8,40,66,0.18)),
            url('http://127.0.0.1:8000/images/pemandangan-sawah.jpg');
            background-size:cover;background-position:center 60%;color:#fff;box-shadow:0 10px 30px rgba(2,6,23,0.08)}
...
<body>
    ...
    <main>
        <section class="hero" aria-label="Hero">
            ...
            <p class="lead">Sistem informasi terintegrasi kawasan Toba</p>
...
<?php /**PATH C:\Users\Joy Silalahi\Documents\GitHub\E-GovToba\resources\views/district-information/villages.blade.php ENDPATH**/ ?>