...
<body>
            ...
            <div class="bupati-section">
                ...
                <div class="bupati-grid">
                    <div class="bupati-card">
                        ...
                        <h6>
                            <span id="bupatiNameDisplay"><?php echo e($district->bupati_name ?? 'Effendi Sintong Panangian Napitupulu'); ?></span>
                            <button class="edit-name-btn" onclick="editName('bupati')" title="Edit Nama">
                                <i class="fas fa-edit"></i>
                            </button>
                        </h6>
                        <div id="bupatiNameForm" class="name-edit-form">
                            <input type="text" id="bupatiNameInput" class="name-input" value="<?php echo e($district->bupati_name ?? 'Effendi Sintong Panangian Napitupulu'); ?>">
                        ...
                        <div class="bupati-period">
                            <span id="periodeDisplay"><?php echo e($district->periode ?? 'Periode 2021-2026'); ?></span>
                            <button class="edit-period-btn" onclick="editPeriod()" title="Edit Periode">
                                <i class="fas fa-edit"></i>
                            </button>
                        </div>
                        <div id="periodeForm" class="period-edit-form">
                            <input type="text" id="periodeInput" class="period-input" value="<?php echo e($district->periode ?? 'Periode 2021-2026'); ?>" placeholder="Contoh: Periode 2021-2026">
                    ...
                    <div class="bupati-card">
                        ...
                        <h6>
                            <span id="wakilNameDisplay"><?php echo e($district->wakil_bupati_name ?? 'Audi Murphy Sitorus'); ?></span>
                            <button class="edit-name-btn" onclick="editName('wakil')" title="Edit Nama">
                                <i class="fas fa-edit"></i>
                            </button>
                        </h6>
                        <div id="wakilNameForm" class="name-edit-form">
                            <input type="text" id="wakilNameInput" class="name-input" value="<?php echo e($district->wakil_bupati_name ?? 'Audi Murphy Sitorus'); ?>">
                            <div class="name-edit-actions">
    ...
    <script>
        ...
        function saveCroppedImage() {
            ...
            canvas.toBlob(function(blob) {
                ...
                const uploadUrl = currentPhotoType === 'bupati' 
                    ? '<?php echo e(route("admin.information.upload-bupati-photo")); ?>'
                    : '<?php echo e(route("admin.information.upload-wakil-bupati-photo")); ?>';
        ...
        function saveName(type) {
            ...
            fetch('<?php echo e(route("admin.information.update-names")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
        ...
        function savePeriod() {
            ...
            fetch('<?php echo e(route("admin.information.update-periode")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
