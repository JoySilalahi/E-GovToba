                    ...
                    <div class="card">
                        ...
                        <div class="news-list" id="newsList">
                            <?php if(isset($beritaList) && $beritaList->count() > 0): ?>
                                ...
                                <article class="news-item" data-type="berita" data-date="<?php echo e($item->date->format('Y-m-d')); ?>">
                                    <div class="news-meta">
                                        ...
                                        <?php endif; ?>
                                        <time datetime="<?php echo e($item->date->format('Y-m-d')); ?>" style="margin-left:auto"><?php echo e($item->date->translatedFormat('d M Y')); ?></time>
                                    </div>
                            ...
                            <?php if(isset($pengumumanList) && $pengumumanList->count() > 0): ?>
                                ...
                                <article class="news-item" data-type="pengumuman" data-date="<?php echo e($item->date->format('Y-m-d')); ?>" style="display:none">
