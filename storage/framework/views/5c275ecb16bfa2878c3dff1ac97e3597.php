    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <ul class="navbar-menu">
                ...
                <li><a href="<?php echo e(route('district.profile')); ?>">Profil Kabupaten</a></li>
                <li><a href="<?php echo e(route('district.villages')); ?>" class="active">Daftar Desa</a></li>
            </ul>
        </div>
    </nav>
...
<?php /**PATH C:\Users\Joy Silalahi\Documents\GitHub\E-GovToba\resources\views/district-information/village-detail.blade.php ENDPATH**/ ?>