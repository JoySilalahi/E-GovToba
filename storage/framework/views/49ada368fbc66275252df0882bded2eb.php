...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li><a href="<?php echo e(route('village-admin.dashboard')); ?>" class="active"><i class="fas fa-home"></i> Beranda</a></li>
            <li><a href="<?php echo e(route('village-admin.kelola-informasi')); ?>"><i class="fas fa-info-circle"></i> Kelola Informasi</a></li>
    ...
    <div class="main-content">
        ...
        <div class="welcome-header" style="background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('<?php echo e($village->image ? asset('images/' . $village->image) : asset('images/default-village.jpg')); ?>') center/cover; padding: 60px 30px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); margin-bottom: 30px; position: relative; overflow: hidden;">
            <div style="position: relative; z-index: 2;">
                <h2 style="font-size: 32px; font-weight: 700; color: white; margin: 0 0 10px 0; text-shadow: 2px 2px 4px rgba(0,0,0,0.3);">Selamat Datang di Desa <?php echo e($village->name); ?></h2>
        ...
        <div class="visi-misi-card">
            ...
            <div class="visi-section">
                <h4>Visi:</h4>
                <p><?php echo e($village->visi ?? 'Visi belum ditetapkan. Klik tombol Edit untuk menambahkan.'); ?></p>
            </div>
            <div class="misi-section" style="margin-top:16px;">
                <h4>Misi:</h4>
                <p><?php echo e($village->misi ?? 'Misi belum ditetapkan. Klik tombol Edit untuk menambahkan.'); ?></p>
            </div>
        </div>
            ...
            <?php if($village->budget_file): ?>
                <div class="alert alert-info" style="background: #d1ecf1; color: #0c5460; border: 1px solid #bee5eb; border-radius: 8px; padding: 12px; margin-bottom: 15px; font-size: 14px; display: flex; align-items: center; gap: 10px;">
                    ...
                    <div style="flex: 1;">
                        ...
                        <small>File saat ini: <?php echo e(basename($village->budget_file)); ?></small>
                    </div>
                    <a href="<?php echo e(asset('storage/' . $village->budget_file)); ?>" target="_blank" style="background: #3498db; color: white; padding: 6px 15px; border-radius: 6px; text-decoration: none; font-size: 13px; white-space: nowrap;">
                        <i class="fas fa-download"></i> Download
                    </a>
                </div>
            <?php endif; ?>

            <form action="<?php echo e(route('village-admin.budget.upload')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
        ...
        <div class="content-grid">
            ...
            <div class="right-panel">
                <div class="stats-column">
                    <div class="stat-card">
                        ...
                        <div class="stat-content">
                            ...
                            <div class="stat-value"><?php echo e(number_format($village->population ?? 900)); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-content">
                            <h5>Luas Area</h5>
                            <div class="stat-value"><?php echo e($village->area ?? '15,2'); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="kepala-desa-card">
                    ...
                    <div class="kepala-desa-name"><?php echo e($village->village_head ?? 'Janri M. Simanjuntak'); ?></div>
...
</html><?php /**PATH C:\Users\ASUS\Documents\E-GovToba\resources\views/village-admin/dashboard.blade.php ENDPATH**/ ?>