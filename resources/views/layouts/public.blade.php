...
<head>
    ...
    <title>@yield('title') - {{ config('app.name', 'Kabupaten Toba') }}</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                ...
                {{ config('app.name', 'Kabupaten Toba') }}
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('profile*') ? 'active' : '' }}" href="{{ route('district.profile') }}">
