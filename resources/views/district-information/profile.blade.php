                    ...
                    <div class="bupati-container">
                        ...
                        <div class="bupati-card">
                            <div class="bupati-photo-wrapper">
                                <img src="{{ asset('images/bupati.jpg') }}?v={{ time() }}" alt="Bupati Toba" class="bupati-photo">
                            </div>
                            <div class="bupati-name">{{ $district->bupati_name ?? 'Effendi Sintong Panangian Napitupulu' }}</div>
                        ...
                        <div class="bupati-card">
                            <div class="bupati-photo-wrapper">
                                <img src="{{ asset('images/wakil-bupati.jpg') }}?v={{ time() }}" alt="Wakil Bupati" class="bupati-photo">
                            </div>
                            <div class="bupati-name">{{ $district->wakil_bupati_name ?? 'Audi Murphy Sitorus' }}</div>
                    ...
                    @foreach($photos as $photo)
                        <div class="doc-card">
                            <img src="{{ asset('storage/' . $photo->photo_path) }}" 
                                 alt="{{ $photo->title ?? 'Dokumentasi Kegiatan' }}" 
                                 class="doc-image">
                            <div style="padding: 12px; background: #fff;">
                                <p style="margin: 0; font-size: 14px; font-weight: 600; color: #1e293b;">
                                    {{ $photo->title ?? 'Kegiatan Kabupaten Toba' }}
                                </p>
